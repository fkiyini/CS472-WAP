...
console.log("max(22, 54) returns " + max(22, 54));
...
console.log("maxOfThree(22, 54, 76) returns " + maxOfThree(22, 54, 76));
...
console.log("isVowel('c') returns " + isVowel('c'));
...
const words = ['Farouk', 'Bobby', 'Allan', 'Polymorphism', 'Taxi']
console.log("findLongestWord(['Farouk', 'Bobby', 'Allan', 'Polymorphism', 'Taxi']) returns " + findLongestWord(words));
...
console.log("filterLongWords(['Farouk', 'Bobby', 'Allan', 'Polymorphism', 'Taxi'], 5) returns " + filterLongWords(words, 5));
...
const sumOfSquare = [1, 2, 3];
console.log("computeSumOfSquares([1, 2, 3]) returns " + computeSumOfSquares(sumOfSquare));
